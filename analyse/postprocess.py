...
def plot(mode, extraction):
    with open(f'result/result_60x60x10/data_raw/{mode}_60x60_{extraction}.json', 'r') as f:
    ...
    fig.savefig(f'result/result_60x60x10/png_raw/{mode}_{extraction}.png', dpi=300)
